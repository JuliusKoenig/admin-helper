...
from admin_helper_cli import __name__ as __package_name__
from admin_helper_cli.console import console
from admin_helper_cli.settings import Settings, settings
...
class TarRotatingFileHandler(RotatingFileHandler):
    ...
    def __init__(self,
                 name: str,
                 filename: str | Path,
                 mode: Settings.LoggerSettings.FileModes = Settings.LoggerSettings.FileModes.a,
                 max_bytes: int = 0,
                 backup_count: int = 0,
...
if settings.logger.console:
    ...
    ch.setFormatter(logging.Formatter(settings.logger.console_format))
...
if settings.logger.file:
    ...
    fh.setFormatter(logging.Formatter(settings.logger.file_format))
